package com.appiadev.popularmovies.model;
...
public class Movie implements Parcelable {
    ...
    public MoviesResponse getMovieTrailer() { return videos; }

    public void setMovieTrailer(MoviesResponse MovieTrailer) { this.videos = videos; }
    ...
    private Movie(Parcel in){
        ...
        this.videos = in.readParcelable(MoviesResponse.class.getClassLoader());
